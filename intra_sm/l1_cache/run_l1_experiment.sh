...
for num_bytes_per_tb in {32768..131072..32768}; do
    ...
    python3 l1_cache.py 2 $num_threads_per_tb $num_bytes_per_tb $unified_l1_cache_size $num_itrs

    # measure concurrent latency of two copy kernels
    python3 l1_cache.py 3 $num_threads_per_tb $num_bytes_per_tb $unified_l1_cache_size $num_itrs
done;